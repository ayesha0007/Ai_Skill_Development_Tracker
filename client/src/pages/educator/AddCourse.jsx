    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        <div className='flex flex-col gap-1'>
          ...
          <section className='grid grid-cols-2 gap-20 mt-4'>
            ...
            <div className='md:flex-row flex-col'>
              <p className='pl-14'>Course Thumbnail</p>
              <label htmlFor="thumbnailImage">
                <img src={assets.file_upload_icon} alt="" className='p-3 ml-32 bg-blue-500 rounded cursor-pointer' />
                <input type="file" id='thumbnailImage' onChange={e => setImage(e.target.files[0])} accept='image/*' hidden />
                {image && <img className='max-h-10 mt-2' src={URL.createObjectURL(image)} alt="" />}
              </label>
            </div>
          </section>
        </div>

      ...
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
            ...
            <div className='flex'>
              {[...Array(5)].map((_, i) => (
                <img className='w-3.5 h-3.5' key={`star-${i}`} src={i < Math.floor(calculateRating(courseData)) ? assets.star : assets.star_blank} alt='' />
              ))}
            </div>
          ...
          <p className='text-sm'>Course By <span className='text-blue-600 underline'>Ayesha Siddika</span></p>
          <div className='pt-8 test-black-500'>
              ...
              {courseData.courseContent.map((chapter, index) => (
                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                  ...
                  <div className={`overflow-hidden transition-all duration-300 ${openSection[index] ? 'max-h-96' : 'max-h-0'}`}>
                    <ul className='list-disk nd:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300'>
        ...
        {/* Right Column */}
        <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded overflow-hidden bg-white min-w-[300px] sm:min-w[420px]'>

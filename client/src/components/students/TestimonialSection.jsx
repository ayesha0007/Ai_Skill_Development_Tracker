...
const TestimonialSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      One of the simplest ways to track your AI skill development is to take self-assessment <br /> quizzes that test your understanding of key concepts and techniques
      </p>
